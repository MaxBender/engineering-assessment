...
from main import (
    MAX_RANDOM_PAGE_ATTEMPTS,
    get_page_summary,
    get_random_page,
    main,
    normalize_page_input,
    prompt_for_user_page,
)
...
def test_prompt_for_user_page_handles_eof():
    with patch('builtins.input', side_effect=EOFError):
        assert prompt_for_user_page() is None


def test_main_handles_eof_during_retry_flow(mock_wiki_functions, mock_input):
    mock_input.side_effect = ['', '', 'NotARealPage', EOFError()]
    mock_wiki_functions['get_page'].side_effect = [
        mock_wiki_functions['get_page'].return_value,
        mock_wiki_functions['get_page'].return_value,
        None,
